...
-- This script handles all possible database states and fixes the inventory_id issue
-- Run this in your Supabase SQL Editor

-- Step 1: Ensure inventory table exists (from complete-schema.sql)
...
-- Step 2: Drop existing stock_movements table if it exists (to fix any column issues)
DROP TABLE IF EXISTS stock_movements CASCADE;

-- Step 3: Create stock_movements table with correct structure
...
-- Create stock movements policies
